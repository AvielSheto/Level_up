            ...
            <aside className="ml-[-100%] fixed z-10 top-0 pb-3 px-6 w-full flex flex-col justify-between h-screen border-r bg-white transition duration-300 md:w-4/12 lg:ml-0 lg:w-[25%] xl:w-[20%] 2xl:w-[15%]">
                <div>
                    <div className="-mx-6 px-6 py-4">
                        <a href="#" title="home">
                            <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRnyCSdsXPi-_gDumYdJFfjx3LcUkkAqP3i1Q&usqp=CAU" className="w-32" alt="tailus logo" />
                        </a>
                    </div>
                    ...
                    <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
                        ...
                        <div>
                            ...
                            <div className="h-full py-6 px-6 rounded-xl border border-gray-200 bg-white">
                                <div className="mb-1 text-base font-medium text-red-700 dark:text-red-500 flex">Alex Shatov<p className='dark:text-black pl-1'>(Frontend)</p></div>
                                <div className="w-full bg-gray-200 rounded-full h-2.5 mb-4 dark:bg-gray-700">
                                    <div className="bg-red-600 h-2.5 rounded-full dark:bg-red-500" style={{ width: '85%' }} />
                                </div>

                                <div className="mb-1 text-base font-medium text-yellow-700 dark:text-yellow-500 flex">Philip Harbach <p className='dark:text-black pl-1'>(Backend)</p></div>
                                <div className="w-full bg-gray-200 rounded-full h-2.5 mb-4 dark:bg-gray-700">
                                    <div className="bg-yellow-400 h-2.5 rounded-full" style={{ width: '65%' }} />
                                </div>
                                <div className="mb-1 text-base font-medium text-indigo-700 dark:text-indigo-500 flex">Mirko Fisuk <p className='dark:text-black pl-1'>(UX/UI)</p></div>
                                <div className="w-full bg-gray-200 rounded-full h-2.5 mb-4 dark:bg-gray-700">
                                    <div className="bg-indigo-600 h-2.5 rounded-full dark:bg-indigo-500" style={{ width: '75%' }} />
                                </div>
                                <div className="mb-1 text-base font-medium text-purple-700 dark:text-purple-500 flex">Olga Semklo <p className='dark:text-black pl-1'>(QA)</p></div>
                                <div className="w-full bg-gray-200 rounded-full h-2.5 dark:bg-gray-700">
                                    <div className="bg-purple-600 h-2.5 rounded-full dark:bg-purple-500" style={{ width: '52%' }} />
                                </div>
                            </div>
                        ...
                        <div className="md:col-span-2 lg:col-span-2">
                            <div className="h-full py-8 pt-10 px-6 space-y-6 rounded-xl border border-gray-200 bg-white">
                                <div className="flex justify-center -mt-16">
                                    <img className="w-20 h-20 object-cover rounded-full border-indigo-500" src="https://github.githubassets.com/images/modules/logos_page/GitHub-Mark.png" />
                                </div>
                                <div>
                                    <h2 className="text-gray-800 text-3xl font-semibold">GitHub</h2>
                                </div>
                                        ...
                                        <div className="flex flex-wrap items-center px-4 py-2">
                                            ...
                                            <div className="relative w-full max-w-full flex-grow flex-1 text-right">
                                                <a href="https://github.com/AvielSheto/Level_up">
                                                    <button className="bg-blue-500 dark:bg-gray-100 text-white active:bg-blue-600 dark:text-gray-800 dark:active:text-gray-700 text-xs font-bold uppercase px-3 py-1 rounded outline-none focus:outline-none mr-1 mb-1 ease-linear transition-all duration-150" type="button">Go to the repository</button>
                                                </a>
                                            </div>
                                        </div>
                                            ...
                                            <ul className="my-1">
                                                    ...
                                                    <div className="flex-grow flex items-center border-b border-gray-100 dark:border-gray-400 text-sm text-gray-600 dark:text-gray-100 py-2">
                                                        <div className="flex-grow flex justify-between items-center">
                                                            <div className="self-center">
                                                                <a className="font-medium text-gray-800 hover:text-gray-900 dark:text-gray-50 dark:hover:text-gray-100" href="#0" style={{ outline: 'none' }}></a> Pull request merged by <a className="font-medium text-gray-800 dark:text-gray-50 dark:hover:text-gray-100" href="#0" style={{ outline: 'none' }}>Sara Smith</a>
                                                            </div>
                                                ...
                                                <li className="flex px-4">
                                                    ...
                                                    <div className="flex-grow flex items-center border-gray-100 text-sm text-gray-600 dark:text-gray-50 py-2">
                                                        <div className="flex-grow flex justify-between items-center">
                                                            <div className="self-center">
                                                                Pull request closed by <a className="font-medium text-gray-800 dark:text-gray-50 dark:hover:text-gray-100" href="#0" style={{ outline: 'none' }}>  </a><a className="font-medium text-gray-800 hover:text-gray-900 dark:text-gray-50 dark:hover:text-gray-100" href="#0" style={{ outline: 'none' }}>Nick Mark</a>
                                                            </div>
                                                            <div className="flex-shrink-0 ml-2">
                                                                <a className="flex items-center font-medium text-blue-500 hover:text-blue-600 dark:text-blue-400 dark:hover:text-blue-500" href="#0" style={{ outline: 'none' }}>
                                                                    View<span><svg width={20} height={20} viewBox="0 0 20 20" fill="currentColor" className="transform transition-transform duration-500 ease-in-out"><path fillRule="evenodd" d="M7.293 14.707a1 1 0 010-1.414L10.586 10 7.293 6.707a1 1 0 011.414-1.414l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414 0z" clipRule="evenodd" /></svg></span>
                                            ...
                                            <ul className="my-1">
                                                <li className="flex px-4">
                                                    ...
                                                    <div className="flex-grow flex items-center border-gray-100 text-sm text-gray-600 dark:text-gray-50 py-2">
                                                        <div className="flex-grow flex justify-between items-center">
                                                            <div className="self-center">
                                                                <a className="font-medium text-gray-800 hover:text-gray-900 dark:text-gray-50 dark:hover:text-gray-100" href="#0" style={{ outline: 'none' }}>Mirko Fisuk</a> Pull request opened by  <a className="font-medium text-gray-800 dark:text-gray-50 dark:hover:text-gray-100" href="#0" style={{ outline: 'none' }}>Newsletter #1</a>
                                                            </div>
                                                            <div className="flex-shrink-0 ml-2">
                                                                <a className="flex items-center font-medium text-blue-500 hover:text-blue-600 dark:text-blue-400 dark:hover:text-blue-500" href="#0" style={{ outline: 'none' }}>
                                                                    View<span><svg width={20} height={20} viewBox="0 0 20 20" fill="currentColor" className="transform transition-transform duration-500 ease-in-out"><path fillRule="evenodd" d="M7.293 14.707a1 1 0 010-1.414L10.586 10 7.293 6.707a1 1 0 011.414-1.414l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414 0z" clipRule="evenodd" /></svg></span>
                        ...
                        <div className="md:col-span-2 lg:col-span-1">
                            <div className="h-full py-8 pt-11 px-6 space-y-6 rounded-xl border border-gray-200 bg-white">
                                ...
                                <div>
                                    <h2 className="text-gray-800 text-3xl font-semibold">Daily meeting</h2>
                                    <a className='text-blue-400' href="https://meet.google.com/gsh-pnen-mfr?pli=1&authuser=0">Link to google meet</a>
                                </div>


                                <div>
                                    <h3 className="text-gray-800 text-2xl font-semibold">Record of today's meeting</h3>

                                    <div className='mt-8'>
                                        <img className='' src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR2UCunLvGRjOOC4Yp3z05ALvO-y92NaCwcvUT7tJmPC8-GmKq9jMxN_jM9kMDNG3EvgPE&usqp=CAU" alt="" />
                                    </div>
